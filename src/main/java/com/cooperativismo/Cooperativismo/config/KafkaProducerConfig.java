...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, PautaSessaoVotacaoResultado> resultadoVotacaoProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, PautaSessaoVotacaoResultado> resultadoVotacaoKafkaTemplate() {
